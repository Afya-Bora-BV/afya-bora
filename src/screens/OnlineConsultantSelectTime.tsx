...
import { Box, VStack, Text, Heading, StatusBar, ScrollView, HStack, Button } from 'native-base'
...
const FindFacility: React.FC = () => {
    ...
    return (
        <VStack flex={1} py={16} px={4} position="relative">
            <VStack space={4}>
                <HeaderwithBack text="Day and Time" onBackPress={() => goBack()} />
                <VStack>
