...
export default function BookAppointment() {
    return (
        <Stack.Navigator headerMode="none">
            <Stack.Screen name={NavKey.ConsultantListScreen} component={ConsultantsList} />
            <Stack.Screen name={NavKey.SetAppointmentTimeScreen} component={SetAppointmentTime} />
            <Stack.Screen name={NavKey.PatientComplaintScreen} component={PatientComplaint} />
        </Stack.Navigator>
    )
}