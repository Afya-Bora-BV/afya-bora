...
export default function AuthenticatedPatientView() {
  return (
    <Tab.Navigator
      lazy
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Home',
          tabBarIcon: ({color, size}) => <TabHomeIcon size={8} color={color} />,
        }}
      />
      <Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Chat',
          tabBarIcon: ({color, size}) => <TabChatIcon size={8} color={color} />,
        }}
      />
      <Tab.Screen
