...
const createAppointmentTempoStore = () =>
	create<AppointmentTempoStore>(
		persist(
			(set, get) => ({
				appointments: [],
...
interface AppointmentTempoStoreProps {
	children?: React.ReactElement;
}
function AppointmentTempoStoreProvider({
	children,
}: AppointmentTempoStoreProps) {
	return (
